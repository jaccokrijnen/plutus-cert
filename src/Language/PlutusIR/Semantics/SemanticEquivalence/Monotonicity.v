...
Proof with (try solve [eauto || lia]).
  ...
  - destruct HRV_cond.
    + left.
      destruct H as [x [e_body [x' [e'_body [Heq [Heq' Hfe]]]]]].
      eexists. eexists. eexists. eexists.
      split... split...
      intros. eapply Hfe...
    + right.
      destruct H as [f [args [f' [args' [Heq [Heq' Hfe]]]]]].
      eexists. eexists. eexists. eexists.
      split... split...
      intros. apply Hfe...
  - destruct HRV_cond as [v_0 [v'_0 [Heq [Heq' Hunwr]]]].
    eexists. eexists.
    split... split...
    intros. eapply Hunwr...
  - destruct HRV_cond as [e_body [e'_body [Heq [Heq' Hie]]]].
    ...
    split... split...
    intros. eapply Hie...
  - destruct HRV_cond as [sv [sv' [Heq [Heq' Hse]]]].
    eexists. eexists.
    split...
  - assumption.
  - assumption.
