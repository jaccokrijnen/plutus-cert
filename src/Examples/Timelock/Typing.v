...
(* Expanding builtins *)
Definition Builtin f := builtin_eta_expand f.
...
(* TODO: [wip/saturated-builtins]: this hangs because solve__TBuiltin needs to
* be refactored with the new typing rules and syntax of builtins


Example pir_0_original_shadowfix__typable :
  ([(ty_EndDate, Kind_Base); (ty_Bool, Kind_Base)]) ,, [] |-+ pir_0_original_shadowfix : (Ty_Fun (Ty_Var ty_EndDate) (Ty_Fun (Ty_Builtin (Some' (TypeIn DefaultUniInteger))) (Ty_Var ty_Bool))).
