...
Proof with eauto_LR.
  ...
  - rename v0 into e_f.
    ...
    split... {
      ...
      eapply closing_preserves_kinding_1 in H as H1...
      eapply closing_preserves_kinding_1 in H0 as H2...
    ...
    split... {
      ...
      eapply preservation in Hkind__T as H...
      eapply preservation in Hkind__F as H0...
      eapply closing_preserves_kinding_2 in H as H1...
      eapply closing_preserves_kinding_2 in H0 as H2...
      eapply strong_normalisation in H1 as H3...
      eapply strong_normalisation in H2 as H6...
      destruct H3. destruct H6.
      eexists.
    ...
    assert (K0 = K). {
      ...
      eapply closing_preserves_kinding_2 in Hkind__T...
      eapply unique_kinds...
    }
    subst.
  ...
  - (* E_Error_Iwrap *)
    ...
    apply RC_to_RV with (j := j1) (e_f := Error T') in HRC as temp...
    destruct temp as [e'_f [j' [Hev__e'_f HRV]]].
