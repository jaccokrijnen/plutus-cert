...
Proof with eauto_LR.
  ...
  split... {
    ...
    split...
    inversion H4. subst.
    replace (@nil (binderName * ty)) with (mgsubst (msyn1 rho) []) by eauto using mgsubst_empty.
  ...
  split... {
    ...
    split...
    inversion H4. subst.
    replace (@nil (binderName * ty)) with (mgsubst (msyn2 rho) []) by eauto using mgsubst_empty.
