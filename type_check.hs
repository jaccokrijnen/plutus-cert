...
data ForallSet a p =
   ForallS_nil
 | ForallS_cons a (List a) p (ForallSet a p) deriving (Prelude.Show)
...
data ForallSet2 a p =
   ForallS2_nil
 | ForallS2_cons (List a) (List (List a)) (ForallSet a p) (ForallSet2 a p) deriving (Prelude.Show)
...
data Recursivity =
   NonRec
 | Rec deriving (Prelude.Show)

data Strictness =
   NonStrict
 | Strict deriving (Prelude.Show)
...
data DefaultFun =
 ...
 | Blake2b_224
 | IntegerToByteString
 | ByteStringToInteger deriving (Prelude.Show)
...
data Vdecl =
   VarDecl BinderName Ty deriving (Prelude.Show)

data Tvdecl =
   TyVarDecl BinderTyname Kind deriving (Prelude.Show)

data Dtdecl =
   Datatype Tvdecl (List Tvdecl) BinderName (List Vdecl) deriving (Prelude.Show)
...
data Has_kind_set =
   K_Var_set (List (Prod String Kind)) String Kind
 | K_Fun_set (List (Prod BinderTyname Kind)) Ty Ty Has_kind_set Has_kind_set
 | K_IFix_set (List (Prod BinderTyname Kind)) Ty Ty Kind Has_kind_set 
 Has_kind_set
 | K_Forall_set (List (Prod BinderTyname Kind)) BinderTyname Kind Ty 
 Has_kind_set
 | K_Builtin_set (List (Prod BinderTyname Kind)) DefaultUni
 | K_Lam_set (List (Prod BinderTyname Kind)) BinderTyname Kind Ty Kind 
 Has_kind_set
 | K_App_set (List (Prod BinderTyname Kind)) Ty Ty Kind Kind Has_kind_set 
 Has_kind_set
 | K_SOP_set (List (Prod BinderTyname Kind)) (List (List Ty)) ForallSet2_has_kind_set
data ForallSet2_has_kind_set =
   ForallSet2_nil_set (List (Prod BinderTyname Kind))
 | ForallSet2_cons_set (List (Prod BinderTyname Kind)) (List Ty) (List
                                                                 (List Ty)) 
 ForallSet_has_kind_set ForallSet2_has_kind_set
data ForallSet_has_kind_set =
   ForallSet_nil_set (List (Prod BinderTyname Kind))
 | ForallSet_cons_set (List (Prod BinderTyname Kind)) Ty (List Ty) Has_kind_set 
 ForallSet_has_kind_set

has_kind_set__ind :: ((List (Prod String Kind)) -> String -> Kind -> () ->
                     a1) -> ((List (Prod BinderTyname Kind)) -> Ty -> Ty ->
                     Has_kind_set -> a1 -> Has_kind_set -> a1 -> a1) ->
                     ((List (Prod BinderTyname Kind)) -> Ty -> Ty -> Kind ->
                     Has_kind_set -> a1 -> Has_kind_set -> a1 -> a1) ->
                     ((List (Prod BinderTyname Kind)) -> BinderTyname -> Kind
                     -> Ty -> Has_kind_set -> a1 -> a1) -> ((List
                     (Prod BinderTyname Kind)) -> DefaultUni -> () -> a1) ->
                     ((List (Prod BinderTyname Kind)) -> BinderTyname -> Kind
                     -> Ty -> Kind -> Has_kind_set -> a1 -> a1) -> ((List
                     (Prod BinderTyname Kind)) -> Ty -> Ty -> Kind -> Kind ->
                     Has_kind_set -> a1 -> Has_kind_set -> a1 -> a1) ->
                     ((List (Prod BinderTyname Kind)) -> (List (List Ty)) ->
                     ForallSet2_has_kind_set -> a2 -> a1) -> ((List
                     (Prod BinderTyname Kind)) -> a2) -> ((List
                     (Prod BinderTyname Kind)) -> (List Ty) -> (List
                     (List Ty)) -> ForallSet_has_kind_set -> a3 ->
                     ForallSet2_has_kind_set -> a2 -> a2) -> ((List
                     (Prod BinderTyname Kind)) -> a3) -> ((List
                     (Prod BinderTyname Kind)) -> Ty -> (List Ty) ->
                     Has_kind_set -> a1 -> ForallSet_has_kind_set -> a3 ->
                     a3) -> (List (Prod BinderTyname Kind)) -> Ty -> Kind ->
                     Has_kind_set -> a1
has_kind_set__ind f0 f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 =
  let {
   f12 _ _ _ h =
     case h of {
      ...
      K_SOP_set _UU0394_ tss f15 ->
       f7 _UU0394_ tss f15 (f13 _UU0394_ tss f15)};
   f13 _ _ f15 =
     case f15 of {
      ForallSet2_nil_set _UU0394_ -> f8 _UU0394_;
      ForallSet2_cons_set _UU0394_ ts tss f16 f17 ->
       f9 _UU0394_ ts tss f16 (f14 _UU0394_ ts f16) f17
         (f13 _UU0394_ tss f17)};
   f14 _ _ f15 =
     case f15 of {
      ForallSet_nil_set _UU0394_ -> f10 _UU0394_;
      ForallSet_cons_set _UU0394_ t ts h f16 ->
...
lookup_app_or_extended :: String -> a1 -> (List (Prod String a1)) -> (List
                          (Prod String a1)) -> Sum () ()
lookup_app_or_extended y _ r1 _ =
  list_rec (\_ -> Inr __) (\a _ iHR1 _ ->
    case a of {
     Pair s _ ->
      let {b = eqb1 y s} in
      case b of {
       True -> eq_rec_r s (\_ _ -> Inl __) y __ iHR1;
       False -> eq_rec_r False (iHR1 __) (eqb1 s y)}}) r1 __

lookup_split_app_helper :: (List (Prod String String)) -> (List
                           (Prod String String)) -> String -> String -> Sum
                           () ()
lookup_split_app_helper r1 _ s s' =
  list_rec (\_ _ -> Inr __) (\a _ iHR1 _ _ ->
    case a of {
     Pair s0 s1 ->
      let {b = eqb1 s0 s} in
      case b of {
       True ->
        eq_rec_r s (\_ ->
          eq_rec_r s' (eq_rec_r s' (\_ _ -> Inl __) s1 __ __) s1) s0 __;
       False ->
        let {s2 = iHR1 __ __} in
        case s2 of {
         Inl _ -> Inl __;
         Inr _ -> Inr __}}}) r1 __ __
  ...
  defaultUni_rec (\x0 -> case x0 of {
    ...
    case x0 of {
     ...
     _ -> Right}) (\x0 -> case x0 of {
                           ...
                           _ -> Right}) (\x0 ->
    case x0 of {
     DefaultUniProtoList -> Left;
     _ -> Right}) (\x0 ->
    case x0 of {
     DefaultUniProtoPair -> Left;
     _ -> Right}) (\x0 -> case x0 of {
                           DefaultUniData -> Left;
                           _ -> Right}) (\x0 ->
    case x0 of {
     DefaultUniBLS12_381_G1_Element -> Left;
     _ -> Right}) (\x0 ->
    case x0 of {
     DefaultUniBLS12_381_G2_Element -> Left;
     _ -> Right}) (\x0 ->
    case x0 of {
     DefaultUniBLS12_381_MlResult -> Left;
     _ -> Right}) (\_ x0 _ x1 x2 ->
    case x2 of {
     DefaultUniApply d d0 ->
      sumbool_rec (\_ -> sumbool_rec (\_ -> Left) (\_ -> Right) (x1 d0))
        (\_ -> Right) (x0 d);
     _ -> Right}) x y
...
list_Ty_dec_axiom :: (List (List Ty)) -> (List (List Ty)) -> Sumbool
list_Ty_dec_axiom =
...
ty_dec x y =
  ty_rec (\t x0 ->
    case x0 of {
     Ty_Var t0 -> sumbool_rec (\_ -> Left) (\_ -> Right) (string_dec t t0);
     _ -> Right}) (\_ x0 _ x1 x2 ->
    case x2 of {
     Ty_Fun t t0 ->
      sumbool_rec (\_ -> sumbool_rec (\_ -> Left) (\_ -> Right) (x1 t0))
        (\_ -> Right) (x0 t);
     _ -> Right}) (\_ x0 _ x1 x2 ->
    case x2 of {
     Ty_IFix t t0 ->
    ...
    case x1 of {
     Ty_Forall b0 k0 t ->
      sumbool_rec (\_ ->
        sumbool_rec (\_ -> sumbool_rec (\_ -> Left) (\_ -> Right) (x0 t))
          (\_ -> Right) (kind_dec k k0)) (\_ -> Right) (string_dec b b0);
     _ -> Right}) (\d x0 ->
    case x0 of {
     Ty_Builtin d0 ->
      sumbool_rec (\_ -> Left) (\_ -> Right) (defaultUni_dec d d0);
     _ -> Right}) (\b k _ x0 x1 ->
    case x1 of {
     Ty_Lam b0 k0 t ->
      sumbool_rec (\_ ->
    ...
    case x0 of {
     Ty_SOP l0 ->
      sumbool_rec (\_ -> Left) (\_ -> Right) (list_Ty_dec_axiom l l0);
     _ -> Right}) x y
...
kind_checking_sound_set :: (List (Prod BinderTyname Kind)) -> Ty -> Kind ->
                           Has_kind_set
kind_checking_sound_set delta ty kind =
  ty_rec (\t delta0 kind0 _ -> K_Var_set delta0 t kind0)
               ...
               Kind_Arrow k5 k6 ->
                case k6 of {
                 Kind_Base ->
                  ...
                  case b of {
                   True -> K_IFix_set delta0 ty1 ty2 k (iHty2 delta0 k __)
    ...
    case o of {
     Some k0 ->
      case k0 of {
       Kind_Base -> K_Forall_set delta0 b k ty0
    ...
    case o of {
     Some k ->
      case k of {
       Kind_Base -> K_Builtin_set delta0 d;
       Kind_Arrow _ _ -> false_rec};
     None -> false_rec}) (\b k ty0 iHty delta0 _ _ ->
    let {o = kind_check (Cons (Pair b k) delta0) ty0} in
    case o of {
     Some k0 -> K_Lam_set delta0 b k ty0 k0
      (iHty (Cons (Pair b k) delta0) k0 __);
...
type LegalRenSwaps = Star (List (Prod String String)) LegalRenSwap
...
lrs_sym ren1 ren2 hlrs =
  legalRenSwap_rec (legalRenSwap_id Nil) (\x y ren3 ren1' _ iHHlrs ->
    Lrs_cons x y ren1' ren3 iHHlrs) (\x y v w ren3 ren1' _ _ _ iHHlrs ->
    Lrs_start v w x y ren1' ren3 iHHlrs) ren1 ren2 hlrs

lrss_cons :: String -> String -> (List (Prod String String)) -> (List
             (Prod String String)) -> LegalRenSwaps -> LegalRenSwaps
lrss_cons x y ren1 ren2 x0 =
  star_rect ren1 StarR (\y0 z _ iHX e -> StarSE (Cons (Pair x y) y0) (Cons
    (Pair x y) z) iHX (Lrs_cons x y y0 z e)) ren2 x0

lrss_intro :: (List (Prod String String)) -> (List (Prod String String)) ->
              LegalRenSwap -> LegalRenSwaps
lrss_intro ren1 ren2 x =
  StarSE ren1 ren2 StarR x

lrss_left :: (List (Prod String String)) -> (List (Prod String String)) ->
             (List (Prod String String)) -> LegalRenSwap -> LegalRenSwaps ->
             LegalRenSwaps
lrss_left ren1 ren2 ren3 hlrs hlrss =
  star_rect ren2 (lrss_intro ren1 ren2 hlrs) (\y z _ iHHlrss e -> StarSE y z
    iHHlrss e) ren3 hlrss

lrss_sym :: (List (Prod String String)) -> (List (Prod String String)) ->
            LegalRenSwaps -> LegalRenSwaps
lrss_sym ren1 ren2 x =
  star_rect ren1 StarR (\y z _ iHX e ->
    lrss_left z y ren1 (lrs_sym y z e) iHX) ren2 x

lrss_trans :: (List (Prod String String)) -> (List (Prod String String)) ->
              (List (Prod String String)) -> LegalRenSwaps -> LegalRenSwaps
              -> LegalRenSwaps
lrss_trans ren1 ren2 ren3 hlrs12 hlrs23 =
  star_rect ren1 (\_ hlrs24 -> hlrs24) (\y z _ iHHlrs12 e ren4 hlrs24 ->
    iHHlrs12 ren4
...
alpha_swaps :: Term0 -> Term0 -> (List (Prod String String)) -> (List
               (Prod String String)) -> LegalRenSwaps -> Alpha -> Alpha
...
alphavar_extend_ids_right :: String -> String -> (List (Prod String String))
                             -> (List (Prod String String)) -> IdCtx ->
                             AlphaVar -> AlphaVar
      ...
      eq_rec_r t
        (eq_rec_r t (\hav0 ->
          idCtx_rec hav0 (\x0 ren _ iHHid ->
            let {b = eqb1 x0 t} in
            case b of {
             True -> eq_rec_r t (Alpha_var_cons t t ren) x0;
             False -> Alpha_var_diff x0 x0 t t ren iHHid}) idCtx hid) s hav)
        s) x __;
   Alpha_var_cons _ _ _ -> false_rec __ __;
...
alphavar_lookup_helper :: (List (Prod String String)) -> String -> String ->
                          AlphaVar -> Sum () ()
alphavar_lookup_helper r s s' x =
  alphaVar_rec (\_ -> Inr __) (\_ _ _ -> Inl __)
    (\_ _ _ _ _ _ _ _ iHAlphaVar ->
    case iHAlphaVar of {
     Inl _ -> Inl __;
     Inr _ -> Inr __}) r s s' x

lookup_some_then_alphavar :: (List (Prod String String)) -> String -> String
                             -> AlphaVar
      ...
      case b of {
       True ->
        eq_rec_r s (\_ _ ->
          let {
           _evar_0_ = \_ ->
            eq_rec_r s' (eq_rec_r s' (\_ -> Alpha_var_cons s s' r0) s1 __) s1}
          in
          eq_rec_r True _evar_0_ (eqb1 s s) __) s0 __ __;
       False -> Alpha_var_diff s0 s1 s s' r0 (iHR __ __)}}) r __ __

lookup_none_then_alpharefl :: (List (Prod String String)) -> String ->
                              AlphaVar
lookup_none_then_alpharefl r s =
  list_rec (\_ _ -> Alpha_var_refl s) (\a r0 iHR _ _ ->
    case a of {
     Pair s0 s1 -> Alpha_var_diff s0 s1 s s r0 (iHR __ __)}) r __ __

alphavar_weaken_id :: (List (Prod String String)) -> (List
                      (Prod String String)) -> String -> String -> String ->
                      IdCtx -> AlphaVar -> AlphaVar
alphavar_weaken_id r idCtx1 s t x hid ha =
  let {ha0 = alphavar_lookup_helper (app r (Cons (Pair x x) idCtx1)) s t ha}
  in
  case ha0 of {
   Inl _ ->
    let {s0 = lookup_split_app_helper r (Cons (Pair x x) idCtx1) s t} in
    case s0 of {
     Inl _ -> lookup_some_then_alphavar (app r idCtx1) s t;
     Inr _ ->
      eq_rec_r s (\_ _ _ _ _ ->
        let {s1 = in_dec string_dec s (map fst idCtx1)} in
        case s1 of {
         Left ->
          case hid of {
           Id_ctx_nil -> false_rec;
...
alpha_weaken_id :: (List (Prod String String)) -> (List (Prod String String))
                   -> Term0 -> Term0 -> String -> String -> IdCtx -> Alpha ->
                   Alpha
alpha_weaken_id r idCtx1 s t x y x0 x1 =
  eq_rec_r y (\h h0 ->
    let {gen_x = app r (Cons (Pair y y) idCtx1)} in
    alpha_rec (\x2 y0 sigma a r0 idCtx2 y1 _ ->
      solution_left (app r0 (Cons (Pair y1 y1) idCtx2)) (\a0 h1 -> Alpha_var
        x2 y0 (app r0 idCtx2) (alphavar_weaken_id r0 idCtx2 x2 y0 y1 h1 a0))
        sigma a) (\b x2 y0 a s1 s2 sigma h1 iHAlpha r0 idCtx2 y1 _ ->
      solution_left (app r0 (Cons (Pair y1 y1) idCtx2)) (\_ iHAlpha0 h2 ->
        Alpha_lam b x2 y0 a s1 s2 (app r0 idCtx2)
        (iHAlpha0 (Cons (Pair x2 y0) r0) idCtx2 y1 __ h2)) sigma h1 iHAlpha)
      (\b s1 s2 t1 t2 sigma h0_ iHAlpha1 h0_0 iHAlpha2 r0 idCtx2 y0 _ ->
      solution_left (app r0 (Cons (Pair y0 y0) idCtx2))
      ...
      solution_left (app r1 (Cons (Pair y0 y0) idCtx2)) (\d0 _ ->
        Alpha_builtin (app r1 idCtx2) d0) r0 d) gen_x s t h0 r idCtx1 y __ h)
    x x0 x1
...
alpha_weaken_ids idCtx s t hid hav =
  list_rec (\_ hav0 -> hav0) (\a idCtx0 iHidCtx hid0 hav0 ->
    iHidCtx
      ...
      (case a of {
        Pair s0 s1 ->
         let {_evar_0_ = alpha_weaken_id Nil idCtx0 s t s0 s1 hid0 hav0} in
         eq_rec_r (app Nil idCtx0) _evar_0_ idCtx0})) idCtx hid hav
...
alpha_extend_vacuous :: String -> String -> Term0 -> Term0 -> (List
                        (Prod String String)) -> Alpha -> Alpha
alpha_extend_vacuous x x' s s' r ha_s =
  alpha_rec (\x0 y sigma a _ _ -> Alpha_var x0 y (Cons (Pair x x') sigma)
    (Alpha_var_diff x x' x0 y sigma a))
    (\b x0 y a s1 s2 sigma _ iHHa_s _ _ -> Alpha_lam b x0 y a s1 s2 (Cons
    (Pair x x') sigma)
    (alpha_swap s1 s2 (Cons (Pair x0 y) (Cons (Pair x x') sigma)) (Cons (Pair
      x x') (Cons (Pair x0 y) sigma)) (Lrs_start x x' x0 y sigma sigma
      (legalRenSwap_id sigma)) (iHHa_s __ __)))
    (\b s1 s2 t1 t2 sigma _ iHHa_s1 _ iHHa_s2 _ _ -> Alpha_app b s1 s2 t1 t2
    (Cons (Pair x x') sigma) (iHHa_s1 __ __) (iHHa_s2 __ __)) (\r0 d _ _ ->
    Alpha_builtin (Cons (Pair x x') r0) d) r s s' ha_s __ __
...
data Has_kind =
 ...
 | K_Fun (List (Prod BinderTyname Kind)) Term0 Term0 Has_kind Has_kind
 | K_IFix (List (Prod BinderTyname Kind)) Term0 Term0 Kind Has_kind Has_kind
 | K_Forall (List (Prod BinderTyname Kind)) BinderTyname Kind Term0 Has_kind
 | K_Builtin (List (Prod BinderTyname Kind)) DefaultUni
 | K_Lam (List (Prod BinderTyname Kind)) BinderTyname Kind Term0 Kind 
 Has_kind
 | K_App (List (Prod BinderTyname Kind)) Term0 Term0 Kind Kind Has_kind 
 Has_kind
...
has_kind_rect :: ((List (Prod String Kind)) -> String -> Kind -> () -> a1) ->
                 ...
                 -> Has_kind -> a1 -> a1) -> ((List (Prod BinderTyname Kind))
                 -> DefaultUni -> () -> a1) -> ((List
                 (Prod BinderTyname Kind)) -> BinderTyname -> Kind -> Term0
                 -> Kind -> Has_kind -> a1 -> a1) -> ((List
                 (Prod BinderTyname Kind)) -> Term0 -> Term0 -> Kind -> Kind
                 -> Has_kind -> a1 -> Has_kind -> a1 -> a1) -> (List
                 (Prod BinderTyname Kind)) -> Term0 -> Kind -> Has_kind -> a1
...
_UU03b1_ctx_sub_extend_ids_right :: (List (Prod String Term0)) -> (List
                                    (Prod String Term0)) -> (List
                                    (Prod String String)) -> (List
                                    (Prod String String)) -> IdCtx ->
                                    Coq__UU03b1_CtxSub -> Coq__UU03b1_CtxSub
...
alpha_preserves_typing :: (List (Prod String String)) -> Term0 -> Term0 ->
                          ...
                          (Prod String Kind)) -> Alpha -> Has_kind ->
                          Has_kind
...
sconstr2_nc_t _ _ x _ _ _ t' p' =
  Nc_cons t' x p' Nil (Nc_nil t')

sconstr2_nc_sub :: String -> Term0 -> String -> Term0 -> Term0 -> Term0 ->
                   Term0 -> Term0 -> NC
sconstr2_nc_sub x0 _ x _ _ s' t' p' =
  Nc_cons (psubs (Cons (Pair x p') Nil) s') x0
    (psubs (Cons (Pair x p') Nil) t') Nil (Nc_nil
    (psubs (Cons (Pair x p') Nil) s'))
...
strip_R_alphavar2 :: (List (Prod String String)) -> String -> String ->
                     AlphaVar -> AlphaVar
strip_R_alphavar2 r s s' ha_s =
  let {ha_s0 = alphavar_lookup_helper r s s' ha_s} in
  case ha_s0 of {
   Inl _ -> lookup_some_then_alphavar (strip_R'' r Nil Nil) s s';
   Inr _ ->
    eq_rec_r s' (\_ -> lookup_none_then_alpharefl (strip_R r) s') s __}

alphavar_vacuous_prepend :: (List (Prod String String)) -> (List
                            (Prod String String)) -> String -> String ->
                            AlphaVar -> AlphaVar
alphavar_vacuous_prepend r1 r2 s s' x =
  list_rec (\_ _ -> x) (\a r3 iHR1 _ _ ->
    case a of {
     Pair s0 s1 -> Alpha_var_diff s0 s1 s s' (app r3 r2) (iHR1 __ __)}) r1 __
    __

alphavar_idk_helper :: (List (Prod String String)) -> (List
                       (Prod String String)) -> (List (Prod String String))
                       -> String -> String -> (AlphaVar -> AlphaVar) ->
                       AlphaVar -> AlphaVar
alphavar_idk_helper r1 r2 r2' s s' x x0 =
  let {h0 = alphavar_lookup_helper (app r1 r2) s s' x0} in
  case h0 of {
   Inl _ ->
    let {hs = lookup_split_app_helper r1 r2 s s'} in
    case hs of {
     Inl _ -> lookup_some_then_alphavar (app r1 r2') s s';
     Inr _ ->
      let {h1 = lookup_some_then_alphavar r2 s s'} in
      let {h = x h1} in alphavar_vacuous_prepend r1 r2' s s' h};
   Inr _ ->
    eq_rec_r s' (\h _ ->
      let {h1 = lookup_none_then_alpharefl r2 s'} in
      let {h2 = h h1} in alphavar_vacuous_prepend r1 r2' s' s' h2) s x __}

strip_R_alphavar_split :: (List (Prod String String)) -> (List
                          (Prod String String)) -> String -> String ->
                          AlphaVar -> AlphaVar
strip_R_alphavar_split r1 r2 s s' =
  alphavar_idk_helper r1 r2 (strip_R r2) s s' (strip_R_alphavar2 r2 s s')

strip_R_preserves_alpha_split :: (List (Prod String String)) -> (List
                                 (Prod String String)) -> Term0 -> Term0 ->
                                 Alpha -> Alpha
strip_R_preserves_alpha_split r1 r2 s s' x =
  term_rec (\s0 _ r3 r4 h ->
    case h of {
     Alpha_var x0 y sigma x1 ->
      eq_rec_r (app r4 r3) (\_ ->
        eq_rec_r s0 (\_ h2 -> Alpha_var s0 y (app r4 (strip_R r3))
          (strip_R_alphavar_split r4 r3 s0 y h2)) x0) sigma __ __ x1;
     Alpha_lam _ _ _ _ _ _ sigma x0 ->
      eq_rec_r (app r4 r3) (\_ -> false_rec) sigma __ __ x0;
     Alpha_app _ _ _ _ _ sigma x0 x1 ->
      eq_rec_r (app r4 r3) (\_ -> false_rec) sigma __ __ x0 x1;
     Alpha_builtin r _ -> eq_rec_r (app r4 r3) (\_ -> false_rec) r __ __})
    (\uSort s0 k s1 iHs _ r3 r4 h ->
    case h of {
     Alpha_var _ _ sigma x0 ->
      eq_rec_r (app r4 r3) (\_ -> false_rec) sigma __ __ x0;
     Alpha_lam b x0 y a s2 s3 sigma x1 ->
      eq_rec_r (app r4 r3) (\_ ->
        eq_rec_r uSort (\_ ->
          eq_rec_r s0 (\_ ->
            eq_rec_r k (\_ ->
              eq_rec_r s1 (\_ h6 -> Alpha_lam uSort s0 y k s1 s3
                (app r4 (strip_R r3)) (iHs s3 r3 (Cons (Pair s0 y) r4) h6))
                s2) a) x0) b __ __ __) sigma __ __ x1;
     Alpha_app _ _ _ _ _ sigma x0 x1 ->
      eq_rec_r (app r4 r3) (\_ -> false_rec) sigma __ __ x0 x1;
     Alpha_builtin r _ -> eq_rec_r (app r4 r3) (\_ -> false_rec) r __ __})
    (\bSort s1 iHs1 s2 iHs2 _ r3 r4 h ->
    case h of {
     Alpha_var _ _ sigma x0 ->
      eq_rec_r (app r4 r3) (\_ -> false_rec) sigma __ __ x0;
     Alpha_lam _ _ _ _ _ _ sigma x0 ->
      eq_rec_r (app r4 r3) (\_ -> false_rec) sigma __ __ x0;
     Alpha_app b s3 s4 t1 t2 sigma x0 x1 ->
      eq_rec_r (app r4 r3) (\_ ->
        eq_rec_r bSort (\_ ->
          eq_rec_r s1 (\_ ->
            eq_rec_r s2 (\_ h5 h6 -> Alpha_app bSort s1 s4 s2 t2
              (app r4 (strip_R r3)) (iHs1 s4 r3 r4 h5) (iHs2 t2 r3 r4 h6)) t1)
            s3) b __ __) sigma __ __ x0 x1;
     Alpha_builtin r _ -> eq_rec_r (app r4 r3) (\_ -> false_rec) r __ __})
    (\d _ r3 r4 h ->
    case h of {
     Alpha_var _ _ sigma x0 ->
     ...
     Alpha_builtin r d0 ->
      eq_rec_r (app r4 r3) (\_ ->
        eq_rec_r d (\_ -> Alpha_builtin (app r4 (strip_R r3)) d) d0) r __ __})
    s s' r2 r1 x

strip_R_preserves_alpha :: (List (Prod String String)) -> Term0 -> Term0 ->
                           Alpha -> Alpha
strip_R_preserves_alpha r s s' =
  strip_R_preserves_alpha_split Nil r s s'
...
not_ftv_to_not_tv :: String -> Term0 -> Prod () Alpha
not_ftv_to_not_tv x s =
  Pair __ (to_GU''__alpha x s)

alpha_trans3 :: (List (Prod String String)) -> Term0 -> Term0 -> Term0 ->
                Term0 -> Alpha -> Alpha -> Alpha -> Alpha
     ...
     Pair _ a0 ->
      let {
       h1 = alpha_trans3 r (to_GU'' x s) s s' (to_GU'' x' s')
              (alpha_sym s (to_GU'' x s) Nil Nil Alpha_sym_nil a) x0 a0}
      in
      alpha_trans3 (Cons (Pair x x') r) s (to_GU'' x s) (to_GU'' x' s') s' a
        (alpha_extend_vacuous x x' (to_GU'' x s) (to_GU'' x' s') r h1)
        (alpha_sym s' (to_GU'' x' s') Nil Nil Alpha_sym_nil a0)}}

alpha_vacuous_R :: Term0 -> Term0 -> (List (Prod String String)) -> (List
                   (Prod String String)) -> Alpha -> Alpha
alpha_vacuous_R s s' r1 r2 x =
  list_rec (\_ _ -> eq_rec_r r2 x (app Nil r2)) (\a r3 iHR1 _ _ ->
    case a of {
     Pair s0 s1 ->
...
_UU03b1_ctx_vacuous_R :: (List (Prod String String)) -> (List
                         (Prod String Term0)) -> (List (Prod String Term0))
                         -> Coq__UU03b1_CtxSub -> Coq__UU03b1_CtxSub
_UU03b1_ctx_vacuous_R r _UU03c3_ _UU03c3_' ha =
  list_rec (\_ _ _ ha0 ->
    case ha0 of {
     Alpha_ctx_nil r0 -> eq_rec_r Nil (\_ _ -> Alpha_ctx_nil r) r0 __ __;
     Alpha_ctx_cons r0 _ _ _ _ _ _ x x0 x1 ->
      eq_rec_r Nil (\_ -> false_rec) r0 __ __ x x0 x1})
    (\_ _UU03c3_0 iH_UU03c3_ _ _ _ ha0 ->
    case ha0 of {
     Alpha_ctx_nil r0 -> eq_rec_r Nil (\_ -> false_rec) r0 __ __;
     Alpha_ctx_cons r0 _UU03c3_1 _UU03c3_'0 x y t t' x0 x1 x2 ->
      eq_rec_r Nil (\_ ->
        eq_rec_r _UU03c3_0 (\_ h1 h3 h5 -> Alpha_ctx_cons r _UU03c3_0
          ...
          (let {h = alpha_vacuous_R t t' r Nil h5} in
           let {_evar_0_ = \h0 -> h0} in eq_rec_r r _evar_0_ (app r Nil) h))
          _UU03c3_1) r0 __ __ x0 x1 x2}) _UU03c3_ _UU03c3_' __ __ ha

a_R_constr_KindOfUniqueRHS :: (List (Prod String String)) -> (List
                              (Prod String String)) -> Term0 -> Term0 ->
                              Term0 -> String -> String -> AlphaVar
a_R_constr_KindOfUniqueRHS r r' s s' t x y =
  let {
   rfr = freshen2
           (app (tv s)
             (app (tv s') (app (tv t) (app (map fst r) (map snd r)))))
           (list_diff string_dec (ftv t) (ftv s))}
  in
  let {
   _evar_0_ = \_ ->
    let {h0 = lookup_app_or_extended x y rfr (strip_R r)} in
    case h0 of {
     Inl _ ->
      let {_evar_0_ = lookup_some_then_alphavar (app rfr (strip_R r)) x y} in
      eq_rec_r (app rfr (strip_R r)) _evar_0_ r';
     Inr _ -> lookup_some_then_alphavar r' x y}}
  in
  eq_rec_r (app rfr (strip_R r)) _evar_0_ r' __
...
a_R_constr_alpha_s r s s' t r' x =
  let {
   rfr = freshen2
           ...
           (list_diff string_dec (ftv t) (ftv s))}
  in
  let {h0 = strip_R_preserves_alpha r s s' x} in
  let {_evar_0_ = alpha_vacuous_R s s' rfr (strip_R r) h0} in
  eq_rec_r (app rfr (strip_R r)) _evar_0_ r'
  ...
  eq_rec_r (a_R_constr r s s' t) (\_ ->
    eq_rec_r
      ...
      (to_GU__alpha_' t (a_R_constr r s s' t)
        ...
        a_R_constr_KindOfUniqueRHS r (a_R_constr r s s' t) s s' t x x0)
        (\x _ _ -> alphavar_refl_weaken_vacuouss x r')) t') r' __
...
r_constr_R2_IdCtx :: Term0 -> Term0 -> (List (Prod String Term0)) -> String
                     -> (List (Prod String String)) -> (List
                     (Prod String String)) -> IdCtx
r_constr_R2_IdCtx t s sigma _ r1 r2 =
  eq_rec_r
    (freshen2
    ...
    eq_rec_r
      (map (\x -> Pair x x)
        (list_diff string_dec (ftv t) (app (btv s) (btv_env sigma))))
      (map_creates_IdCtx
        (list_diff string_dec (ftv t) (app (btv s) (btv_env sigma)))) r2) r1
    __
...
r_constr__a_sigma :: (List (Prod String String)) -> (List
                     (Prod String String)) -> Term0 -> Term0 -> (List
                     (Prod String Term0)) -> String -> Coq__UU03b1_CtxSub
r_constr__a_sigma r1 r2 t s sigma x =
...
t_constr__a_sigma :: Term0 -> Term0 -> (List (Prod String String)) -> Term0
                     ...
                     Coq__UU03b1_CtxSub
t_constr__a_sigma t t' r s sigma x =
  let {p = r_constr t s sigma x} in
  case p of {
   Pair l l0 ->
    eq_rec_r
      (snd
        (to_GU_ (app (tv t) (app (tv s) (tv_keys_env sigma))) (app l l0) t))
      (\_ -> eq_rec_r (app l l0) (r_constr__a_sigma l l0 t s sigma x) r) t'
      __}
...
t_constr__nc_subs _ t' _ s sigma x =
  Nc_cons (subs sigma s) x t' Nil (Nc_nil (subs sigma s))
...
data InSet a =
   InSet_head (List a)
 | InSet_tail a (List a) (InSet a)

in_app_or_set :: a1 -> (List a1) -> (List a1) -> (InSet a1) -> Sum (InSet a1)
                 (InSet a1)
in_app_or_set _ l1 _ =
  list_rect (\h -> Inr h) (\h t iH h0 ->
    case h0 of {
     InSet_head _ -> Inl (InSet_head t);
     InSet_tail _ _ x ->
      let {s = iH x} in
      case s of {
       Inl i -> Inl (InSet_tail h t i);
       Inr i -> Inr i}}) l1

in_dec_f :: (a1 -> a1 -> Sumbool) -> a1 -> (List a1) -> Bool
in_dec_f eq_dec x l =
  case l of {
   Nil -> False;
   Cons h hs ->
    case eq_dec x h of {
     Left -> True;
     Right -> in_dec_f eq_dec x hs}}

in_dec_f_sound :: (a1 -> a1 -> Sumbool) -> a1 -> (List a1) -> InSet a1
in_dec_f_sound eq_dec x l =
  list_rect (\_ -> Prelude.error "absurd case") (\h t iH _ ->
    let {s = eq_dec x h} in
    case s of {
     Left -> InSet_head t;
     Right -> InSet_tail h t (iH __)}) l __

in_prop_to_set :: String -> (List String) -> InSet String
in_prop_to_set x l =
  let {b = in_dec_f string_dec x l} in
  case b of {
   True -> in_dec_f_sound string_dec x l;
   False -> Prelude.error "absurd case"}

alpha_extend_id'' :: Term0 -> String -> (List (Prod String String)) -> Alpha
                     -> Alpha
alpha_extend_id'' s z ren =
  let {s0 = in_dec string_dec z (ftv s)} in
  (\x ->
  case s0 of {
   Left ->
    let {
     h0 = alpha_rec (\x0 y sigma a _ _ ->
            ...
            solution_left t1 (\sigma0 h1 h2 iHAlpha3 iHAlpha4 _ _ ->
              solution_left s1 (\t3 _ _ _ iHAlpha5 iHAlpha6 _ ->
                let {i = in_prop_to_set z (app (ftv s1) (ftv t3))} in
                let {i0 = in_app_or_set z (ftv s1) (ftv t3) i} in
                case i0 of {
                 Inl _ -> iHAlpha5 __ __;
                 Inr _ -> iHAlpha6 __ __}) s2 t1 sigma0 h1 h2 iHAlpha3
                iHAlpha4 __) t2 sigma h h0 iHAlpha1 iHAlpha2 __ __)
            (\_ _ _ _ -> Prelude.error "absurd case") ren s s x __ __}
    in
    alpha_extend_id' s s z ren x h0;
   Right -> alpha_extend_vacuous_ftv z z s s ren x})

alpha_rename_binder_stronger :: String -> String -> Term0 -> Term0 -> Term0
                                -> (List (Prod String String)) -> Term0 ->
                                (List (Prod String String)) -> Alpha -> Alpha
                                -> LegalRenSwaps -> NC -> NC -> Alpha
alpha_rename_binder_stronger x y s t t' rt s' rs x0 x1 x2 x3 x4 =
  term_rect (\s0 _ _ _ _ _ rs0 h rt0 h0 x5 ->
    case h of {
     Alpha_var x6 y0 sigma x7 ->
      eq_rec_r rs0 (\_ ->
        eq_rec_r s0 (\_ _ ->
          let {b = eqb1 x s0} in
          case b of {
           ...
           False ->
            ...
            case b0 of {
             ...
             False ->
              let {
               h1 = alpha_swaps (Tmvar s0) (Tmvar y0) (Cons (Pair x y) rt0)
                      rs0 (lrss_sym (Cons (Pair x y) rt0) rs0 x5) h}
              in
              case h1 of {
               Alpha_var x8 y1 sigma0 x9 ->
                      ...
                      case h9 of {
                       ...
                       Alpha_var_cons z w sigma1 ->
                        eq_rec_r x (\_ ->
                          eq_rec_r y (\_ ->
                            eq_rec_r rt0 (\_ ->
                              eq_rec_r s0 (\_ -> eq_rec_r y0 false_rec y) x)
                              sigma1) w) z __ __ __ __;
                       Alpha_var_diff x10 y2 z w sigma1 x11 ->
                        eq_rec_r x (\_ ->
                          eq_rec_r y (\_ ->
                            eq_rec_r rt0 (\_ ->
                              eq_rec_r s0 (\_ ->
                                eq_rec_r y0 (\_ _ h14 -> Alpha_var s0 y0 rt0
                                  h14) w) z) sigma1) y2) x10 __ __ __ __ __
                          __ x11}) y1) x8) sigma0 __ __ x9;
               Alpha_lam _ _ _ _ _ _ sigma0 x8 ->
                eq_rec_r (Cons (Pair x y) rt0) (\_ -> false_rec) sigma0 __ __
                  x8;
               Alpha_app _ _ _ _ _ sigma0 x8 x9 ->
                eq_rec_r (Cons (Pair x y) rt0) (\_ -> false_rec) sigma0 __ __
                  x8 x9;
               Alpha_builtin r _ ->
     ...
     Alpha_lam _ _ _ _ _ _ sigma x6 ->
      eq_rec_r rs0 (\_ -> false_rec) sigma __ __ x6;
     Alpha_app _ _ _ _ _ sigma x6 x7 ->
      eq_rec_r rs0 (\_ -> false_rec) sigma __ __ x6 x7;
     Alpha_builtin r _ -> eq_rec_r rs0 (\_ -> false_rec) r __ __})
    (\uSort s0 k s1 iHs _ t'0 h2 t0 h1 rs0 h rt0 h0 x5 ->
    case h of {
     Alpha_var _ _ sigma x6 -> eq_rec_r rs0 (\_ -> false_rec) sigma __ __ x6;
     Alpha_lam b x6 y0 a s2 s3 sigma x7 ->
      eq_rec_r rs0 (\_ ->
        eq_rec_r uSort (\_ ->
          eq_rec_r s0 (\_ ->
            eq_rec_r k (\_ ->
              eq_rec_r s1 (\_ h9 -> Alpha_lam uSort s0 y0 k (sub x t0 s1)
                (sub y t'0 s3) rt0
                (iHs s3 t'0 (nc_lam uSort y0 s3 k (Cons (Pair y t'0) Nil) h2)
                  t0 (nc_lam uSort s0 s1 k (Cons (Pair x t0) Nil) h1) (Cons
                  (Pair s0 y0) rs0) h9 (Cons (Pair s0 y0) rt0)
                  (alpha_extend_vacuous_ftv s0 y0 t0 t'0 rt0 h0)
                  (lrss_trans (Cons (Pair x y) (Cons (Pair s0 y0) rt0)) (Cons
                    (Pair s0 y0) (Cons (Pair x y) rt0)) (Cons (Pair s0 y0)
                    rs0) (StarSE (Cons (Pair x y) (Cons (Pair s0 y0) rt0))
                    (Cons (Pair s0 y0) (Cons (Pair x y) rt0)) StarR
                    (Lrs_start x y s0 y0 rt0 rt0 (legalRenSwap_id rt0)))
                    (lrss_cons s0 y0 (Cons (Pair x y) rt0) rs0 x5)))) s2) a)
            x6) b __ __ __) sigma __ __ x7;
     Alpha_app _ _ _ _ _ sigma x6 x7 ->
      eq_rec_r rs0 (\_ -> false_rec) sigma __ __ x6 x7;
     Alpha_builtin r _ -> eq_rec_r rs0 (\_ -> false_rec) r __ __})
    (\bSort s1 iHs1 s2 iHs2 _ t'0 h2 t0 h1 rs0 h rt0 h0 x5 ->
    case h of {
     Alpha_var _ _ sigma x6 -> eq_rec_r rs0 (\_ -> false_rec) sigma __ __ x6;
     Alpha_lam _ _ _ _ _ _ sigma x6 ->
      eq_rec_r rs0 (\_ -> false_rec) sigma __ __ x6;
     Alpha_app b s3 s4 t1 t2 sigma x6 x7 ->
      eq_rec_r rs0 (\_ ->
        eq_rec_r bSort (\_ ->
          eq_rec_r s1 (\_ ->
            eq_rec_r s2 (\_ h8 h9 -> Alpha_app bSort (sub x t0 s1)
              (sub y t'0 s4) (sub x t0 s2) (sub y t'0 t2) rt0
              (iHs1 s4 t'0 (nc_app_l bSort s4 t2 (Cons (Pair y t'0) Nil) h2)
                t0 (nc_app_l bSort s1 s2 (Cons (Pair x t0) Nil) h1) rs0 h8
                rt0 h0 x5)
              (iHs2 t2 t'0 (nc_app_r bSort s4 t2 (Cons (Pair y t'0) Nil) h2)
                t0 (nc_app_r bSort s1 s2 (Cons (Pair x t0) Nil) h1) rs0 h9
                rt0 h0 x5)) t1) s3) b __ __) sigma __ __ x6 x7;
     Alpha_builtin r _ -> eq_rec_r rs0 (\_ -> false_rec) r __ __})
                      ...
                      eq_rec_r a (\_ ->
                        eq_rec_r s0 (\_ h10 -> ExistT (sub y t2 s3) (Pair
                          ...
                          (alpha_rename_binder_stronger x3 y s0 t0 t2 r0 s3
                            (Cons (Pair x3 y) r0) h10 h8 StarR
...
soundness :: (List (Prod BinderTyname Kind)) -> Term0 -> Kind -> Has_kind ->
...
soundness gamma s a _top_assumption_ x sigma x0 x1 x2 =
  ...
  has_kind_rect (\gamma0 x3 a0 _ gu sigma0 _ nc ->
    ...
    (\_UU0394_ t _ x3 sigma0 _ x4 ->
    unsafeCoerce _evar_0_3 _UU0394_ t x3 sigma0 x4)
...
type_L :: (List (Prod String Kind)) -> Term0 -> Kind -> Has_kind -> L
type_L e s t htype =
...
sN_naive :: (List (Prod BinderTyname Kind)) -> Term0 -> Kind -> Has_kind ->
            Sn Term0 Step_gu_naive
sN_naive e s t x =
...
f_preserves_kind :: (List (Prod BinderTyname Kind)) -> Ty -> Kind -> Has_kind
f_preserves_kind _UU0394_ s k =
  ...
  has_kind_set__ind (\_UU0394_0 x k0 _ -> K_Var _UU0394_0 x k0)
    ...
    (let {
      f0 t =
        case t of {
         ...
         Ty_Forall x a t0 -> Tmlam ForAll x a (f0 t0);
         Ty_Builtin d -> Tmbuiltin d;
         Ty_Lam x a t0 -> Tmlam Lam x a (f0 t0);
    ...
    (\_UU0394_0 f0 t k0 _ iHhas_kind_set1 _ iHhas_kind_set2 -> K_IFix
    _UU0394_0
    (let {
      f1 t0 =
        case t0 of {
         ...
         Ty_Forall x a t1 -> Tmlam ForAll x a (f1 t1);
         Ty_Builtin d -> Tmbuiltin d;
         Ty_Lam x a t1 -> Tmlam Lam x a (f1 t1);
        ...
        case t0 of {
         ...
         Ty_SOP tss ->
          fold_right (\ts acc ->
            fold_right (\t1 acc2 -> Tmapp Fun (f1 t1) acc2) acc ts)
            (Tmbuiltin DefaultUniInteger) tss}}
     in f1 t) k0 iHhas_kind_set1 iHhas_kind_set2)
    (\_UU0394_0 x k0 t _ iHhas_kind_set -> K_Forall _UU0394_0 x k0
    (let {
      f0 t0 =
        case t0 of {
         Ty_Var x0 -> Tmvar x0;
         ...
         Ty_Forall x0 a t1 -> Tmlam ForAll x0 a (f0 t1);
         Ty_Builtin d -> Tmbuiltin d;
         Ty_Lam x0 a t1 -> Tmlam Lam x0 a (f0 t1);
    ...
    (\_UU0394_0 x k1 t k2 _ iHhas_kind_set -> K_Lam _UU0394_0 x k1
    (let {
      f0 t0 =
        case t0 of {
         Ty_Var x0 -> Tmvar x0;
        ...
        case t of {
         ...
         Ty_SOP tss ->
          fold_right (\ts acc ->
            fold_right (\t0 acc2 -> Tmapp Fun (f0 t0) acc2) acc ts)
            (Tmbuiltin DefaultUniInteger) tss}}
     in f0 t2) k1 k2 iHhas_kind_set1 iHhas_kind_set2)
    (\_UU0394_0 tss h0 iHhas_kind_set ->
    list_rec (\_ _ -> K_Builtin _UU0394_0 DefaultUniInteger)
      (\a tss0 _ h1 iHhas_kind_set0 ->
      let {l = Cons a tss0} in
      forallSet2_rec (\_ -> K_Builtin _UU0394_0 DefaultUniInteger)
        (\x xs f0 _ iHIHhas_kind_set h2 ->
        forallSet_rec (\h3 ->
          iHIHhas_kind_set
            (case h3 of {
              ForallSet2_nil_set _UU0394_1 ->
               eq_rec_r _UU0394_0 (\_ -> false_rec) _UU0394_1 __;
              ForallSet2_cons_set _UU0394_1 ts tss1 x0 x1 ->
               eq_rec_r _UU0394_0 (\_ ->
                 eq_rec_r Nil (\_ -> eq_rec_r xs (\_ h4 -> h4) tss1) ts __)
                 _UU0394_1 __ x0 x1})) (\x0 xs0 p _ iHf0 h3 -> K_Fun
          _UU0394_0 (f x0)
          (fold_right (\t acc2 -> Tmapp Fun (f t) acc2)
            (fold_right (\ts acc ->
              fold_right (\t acc2 -> Tmapp Fun (f t) acc2) acc ts) (Tmbuiltin
          ...
          (iHf0
            (case h3 of {
              ForallSet2_nil_set _UU0394_1 ->
               eq_rec_r _UU0394_0 (\_ -> false_rec) _UU0394_1 __;
              ForallSet2_cons_set _UU0394_1 ts tss1 x1 x2 ->
               eq_rec_r _UU0394_0 (\_ ->
                 eq_rec_r (Cons x0 xs0) (\_ ->
                   eq_rec_r xs (\h4 h5 ->
                     case h4 of {
                      ForallSet_nil_set _UU0394_2 ->
                       eq_rec_r _UU0394_0 (\_ -> false_rec) _UU0394_2 __;
                      ForallSet_cons_set _UU0394_2 t ts0 x3 x4 ->
                       eq_rec_r _UU0394_0 (\_ ->
                         eq_rec_r x0 (\_ ->
                           eq_rec_r xs0 (\_ h6 -> ForallSet2_cons_set
                             _UU0394_0 xs0 xs h6 h5) ts0) t __) _UU0394_2 __
                         x3 x4}) tss1) ts __) _UU0394_1 __ x1 x2}))) x f0 h2)
        l iHhas_kind_set0 h1) tss h0 iHhas_kind_set) (\_ -> ForallS2_nil)
    (\_ ts tss _ iHhas_kind_set _ iHhas_kind_set0 -> ForallS2_cons ts tss
    iHhas_kind_set iHhas_kind_set0) (\_ -> ForallS_nil)
    (\_ t ts _ iHhas_kind_set _ iHhas_kind_set0 -> ForallS_cons t ts
    iHhas_kind_set iHhas_kind_set0) _UU0394_ s k h
...
plutus_ty_strong_normalization :: Ty -> (List (Prod BinderTyname Kind)) ->
                                  Kind -> Sn Ty Step
plutus_ty_strong_normalization s _UU0394_ k =
  let {hwk = f_preserves_kind _UU0394_ s k} in
  let {hwk0 = strong_normalization _UU0394_ (f s) k hwk} in
  sn_step_plut s hwk0
        ...
        case o0 of {
         Some k3 ->
          ...
          case b of {
                      ...
                      case s0 of {
                       ...
                       Inr _ ->
                        ty_rec (\_ _ _ _ _ _ _ -> Inr __)
                          ...
                          (substituteTCA0 b1 t2 t3) (Step_beta b1 k7 t3 t2)))
                          (\_ _ _ _ _ _ _ _ _ _ -> Inr __) (\l _ _ _ _ _ _ ->
                          let {
           ...
           False -> false_rec};
         None -> false_rec}};
     None -> false_rec}) (\_ _ _ _ -> Inr __) t _UU0394_ k __

type SN = Sn Ty Step

sN_normalise :: Ty -> (List (Prod BinderTyname Kind)) -> Kind -> SN -> SigT
                Ty ()
sN_normalise t _UU0394_ k hSN =
  sn_rec (\t0 _ h _ ->
    ...
    case s0 of {
     ...
     Inr _ -> ExistT t0 __}) t hSN __

normaliser :: Ty -> (List (Prod BinderTyname Kind)) -> Kind -> Ty
normaliser t _UU0394_ k =
...
normaliser_Jacco _UU0394_ t =
  case kind_check _UU0394_ t of {
   Some k -> Some (normaliser t _UU0394_ k);
   None -> None}
